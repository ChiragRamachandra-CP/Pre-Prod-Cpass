...
export const platinumId = 'CP_PLATINUM_YEAR_NATIONAL';
export const platinumINR = 'INR';

export const goldPass = 'CollegePass Gold Pass';
export const goldAmt = 29999;
export const goldId = 'CP_GOLD_YEAR_NATIONAL';
export const goldINR = 'INR';

export const silverPass = 'CollegePass Silver Pass';
export const silverAmt = 9999;
export const silverId = 'CP_SILVER_YEAR_NATIONAL';
export const silverINR = 'INR';
