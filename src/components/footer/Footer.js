						...
						<div className="footer-mainsec">
							<div className="col-md-4 mob-wid-set">
								<div className="ftr-mnu explore">
									...
									<div className="ftr-mnu-l" style={{paddingBottom: '20px!important'}}>
										<ul>
											<li>
												<a href="#upcomigTop">SAT Solutions</a>
											</li>
											<li>
												<a href="#videoLessonsTop">SAT Solutions For Class 12</a>
											</li>
											<li>
												<a href="# ">SAT Solutions For Class 12 Maths</a>
											</li>
											<li>
												<a href="# ">SAT Solutions For Class 12 Physics</a>
											</li>
											<li>
												<a href="# ">SAT Solutions For Class 12 Chemistry</a>
											</li>
										</ul>
