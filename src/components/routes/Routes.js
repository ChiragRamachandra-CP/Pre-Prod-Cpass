...
const CategoriesMainPage = lazy(() =>
	import("../../pages/categories/CategoriesMainPage")
);
const Archive = lazy(() => import("../../pages/archive/Archive"));
const CategoryVideosPage = lazy(() =>
	import("../../pages/categories/CategoryVideosPage")
);
const PlayVideo = lazy(() => import("../../pages/playVideo/PlayVideo"));
const UpcomingLiveSessionAll = lazy(() =>
	import("../../pages/live/UpcomingLiveSessionAll")
);
...
const SuccesfullValidate = lazy(() =>
	import("../../pages/emailValidation/SuccesfullValidate")
);
const PSATTutoring = lazy(() =>
	import("../../pages/landingPages/PSATTutoring")
);
const SatMasterClassPro = lazy(() =>
	import("../../pages/landingPages/SatMasterClassPro")
);
		...
		<Fragment>
			...
			>
				<Switch onUpdate={() => window.scrollTo(0, 0)}>
					...
					<Route
						exact
						path="/successfullyValidate/:valTok"
						component={SuccesfullValidate}
					/>
					<Route
						exact
						path="/"
						component={isAuthenticated ? HomeAfterLogin : HomeBeforeLogin}
					/>
					...
					<Route exact path="/psat-tutoring" component={PSATTutoring} />
					<Route
						exact
