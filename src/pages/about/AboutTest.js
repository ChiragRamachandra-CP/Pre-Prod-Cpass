				...
				<section className="newest-class aboutmain aboutmainTest">
					<div className="container">
						<div className="new-class aboutestw">
							...
							>
								CollegePass is making High Quality College Admission Advice,
								Standardised Test Preparation accessible to High Schoolers
								worldwide at the click of a button!
							</p>
						</div>
						...
						<div className="new-class aboutestv">
							...
							<div className="testvideo">
								<video width="1000px" id="sing_vd" autoplay muted>
									<source
										src="../../assets/images/Marketing.mp4"
										type="video/mp4"
									/>
								</video>
							</div>
						...
						<div className="new-class aboutestw" id="missionID">
							...
							>
								We believe World Class, Live Content delivered in a personalised
								and affordable way using technology is the key to ensuring every
								child has access to his own virtual private college coach.
							</p>
						</div>

						<section
							className="single_video"
							style={{maxWidth: "100%", width: "900px", margin: "auto"}}
						>
							<div className="upcmngls">
								<div className="frsttxt">
									...
									>
										CollegePass Comprehensive College Preparation includes:
									</h2>
									<li className="fvlnetxt">
										College Admission Advice from a Global Network of Advisors
									</li>
									<li className="fvlnetxt">
										Personalised Application: Application Timeline and To Do’s
										for each School Year
									</li>
									<li className="fvlnetxt">
										SAT/PSAT/IELTS/ACT Preparation with International Master
										Tutors
									</li>
									<li className="fvlnetxt">
										IB/IGCSE Tutoring with Experienced International Curriculum
										Tutors
									</li>
								</div>
							</div>
