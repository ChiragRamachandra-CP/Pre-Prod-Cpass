						...
						<section className="single_video">
							<div className="upcmngls">
								<div className="frsttxt">
									...
									<li className="fvlnetxt">CollegePass Tutors are Internationally, Experienced Tutors!</li>
									<li className="fvlnetxt">CollegePass Tutors have graduated from leading universities worldwide.</li>
									<li className="fvlnetxt">CollegePass Students have consistently scored 1500+ in Consecutive SAT Test Dates in 2019-20</li>
